...
Revision ID: 1203c766daf2
Revises: 
Create Date: 2021-04-18 17:21:03.102597
...
def upgrade():
    ...
    op.create_table('signed_timestamp',
    ...
    op.create_index(op.f('ix_signed_timestamp_interval'), 'signed_timestamp', ['interval'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_signed_timestamp_interval'), table_name='signed_timestamp')

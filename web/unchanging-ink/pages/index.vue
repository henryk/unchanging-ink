...
const textPlaceholder = computed(() => createInput.value.files.length ? t('optionAddMoreFiles') : t('dropTextOrDragFile'))
const filesPlaceholder = computed(() => createInput.value.text.length ? '' : t('alternateSelectFile'))
